...
identifies drought events in a time series when a given index falls
below a specified threshold for at least `min_duration` consecutive
months (2 by default).
...
draws the index as a bar plot, coloring positive (wet, *blue*) and
negative (dry, *red*) periods differently.
...
![](reference/figures/README-plot-ts-1.png)
...
![](reference/figures/README-plot-ts-by-year-1.png)

### Highlight drought events on the plot

[`add_drought_events()`](https://ajpelu.github.io/droughtevents/reference/add_drought_events.md)
overlays the detected events on top of a plot created with
[`plot_drought_ts()`](https://ajpelu.github.io/droughtevents/reference/plot_drought_ts.md),
as shaded bands or vertical lines, or both.
...
![](reference/figures/README-plot-with-events-1.png)
...
[`?spei_granada`](https://ajpelu.github.io/droughtevents/reference/spei_granada.md)
for details and the data source.
